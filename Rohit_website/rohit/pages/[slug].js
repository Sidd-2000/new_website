...
const Post = ({addToCart,product,variants}) => {
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-55 object-cover object-top rounded" src="/chair.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button onClick={()=>{addToCart(slug,1,499,"wear the code",'XL',"red")}} className="flex ml-3 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
        ...
        <div className='pin mt-6 flex space-x-2 text-sm'>
          <input onChange={onChangePin} className='border-2 border-pink-400 rounded-md hover:border-pink-400 px-2'placeholder='Enter your pincode' type='text'></input>
          <button onClick={checkServiceavailbility} className="flex ml-3 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">check</button>
        </div>
        {(!service && service!=null) && <div className='text-red-600 mt-2 text-sm'>Sorry !  We do not deliver to this pincode</div>}
        {(service && service !=null) && <div className='text-green-600 mt-2 text-sm'>Yay! This is serviceable</div>}
      </div>
    </div>
  </div>
</section>
